...
Estimate the political ideology of this user. Then, find the five screen names most frequently mentioned by this user and estimate their political ideology too. Are they all similar? (Note that this method will only work for US-based accounts.)
